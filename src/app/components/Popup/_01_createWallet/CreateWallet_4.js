...
import { nToBr, isEmpty, generateIconsdkObject } from 'utils';
...
class CreateWallet4 extends Component {
  ...
  setIconsdkObject = (v3) => {
    ...
    const iconsdkObj = generateIconsdkObject(address, coinType, walletName, v3)
    this.props.createWallet(iconsdkObj);
    this.props.logIn();
  }
  ...
  handleSubmit = (e) => {
    if (isEmpty(this.props.iconsdkObj)) {
      ...
      this.props.createWallet(this.props.iconsdkObj);
      this.props.logIn();
    }
  }
